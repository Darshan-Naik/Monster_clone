        ...
        <div className="flexBox searchBoxAdvance">
            <form onSubmit={handleSubmit}>
                <div className="searchJob_inputBody">
                    <div className='input'>
                        <input type="text" value={job_title} name="job_title" placeholder='Search for keyword'
                            onChange={handleChange} />
                    </div>
                    <div className="multipleInputs">
                        <input className='inputi' placeholder='Experience' type="text" value={experience}
                            name="experience" onChange={handleChange} />
                        <input className='inputi' placeholder='Location' type="text" value={location} name="location"
                            onChange={handleChange} />
                    </div>
                    <div className='input'>
                        <input list="company" name="company" placeholder='Company Name' value={company}
                            onChange={handleChange} />
                        <datalist id="company">
                    ...
                    <div className='input'>
                        <input list="jobtype" name="jobtype" placeholder='Type' value={jobtype}
                            onChange={handleChange} />
                        <datalist id="jobtype">
                    ...
                    <div className="multipleInputs">
                        <input list="min_salary" className='inputi' name="min_salary" placeholder='Minimum Salary'
                            value={min_salary} onChange={handleChange} />
                        <datalist id="min_salary">
                            {Minimumsalary.map((item)=>
                            <option value={item} />) }
                        </datalist>
                        <input list="max_salary" className='inputi' name="max_salary" placeholder='Maximum Salary'
                            value={max_salary} onChange={handleChange} />
                        <datalist id="max_salary">
                            {Maximumsalary.map((item)=>
                            <option value={item} />) }
                        </datalist>
                    </div>
