...
<div className="monster">
    ...
    <div className="resume__card">
        <img src="https://media.monsterindia.com/trex/prod-cdn/media/product/2018/october/wNt90Vciwjtw05UbukHOpwS7RMYiGCkw9cKwWiAG.png"
            alt="" />
        <div className="resume__description">
            <h4>Xpress Resume+</h4>
            <p>
    ...
    <div className="resume__card">
        <img src="https://media.monsterindia.com/trex/prod-cdn/media/product/2018/october/DZjYfGoeHQ8Ese8lZnCaAWQwkmh0cMd9LCphNIJi.png"
            alt="" />
        <div className="resume__description">
