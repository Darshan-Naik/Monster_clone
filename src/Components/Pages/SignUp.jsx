...
export const Registration = () => {
  return (
    <div className={styles.mainDiv}>
      ...
      <hr />
      <div >
        <label className={styles.label}>Upload Resume<span>(*.doc,.pdf,*.docs,*.rtf)</span></label><br/>
        <input className={styles.choose} required type="file" />
        <form>
          <label className={styles.label}>Full Name</label><br />
          <input required className={styles.inp} type="text" placeholder="Enter your full name" /><br />
          <label className={styles.label}>Email ID</label><br />
          <input required className={styles.inp} type="email" placeholder="Please enter your email" /><br />
          <label className={styles.label}>Password</label><br />
          <input required className={styles.inp} type="email" placeholder="Password should be minimum 6 characters" /><br />
          ...
          <input required className={styles.selec} placeholder="Your number for employers to reach you" /><br />
          <label className={styles.label}>Current Location</label><br/>
          <input required className={styles.inp} placeholder="Please select your current location" /><br />
          <label className={styles.label}>Total Experience</label><br/>
          <input required className={styles.inp} placeholder="select experience(e.g. Fresher or Experience)" /><br />
          <label className={styles.label}>Key Skills</label><br/>
          <input required className={styles.inp} placeholder="Enter or select your skills" /><br />
          
          <label className={styles.label}>Preferred Industry</label><br/>
          ...
          <label className={styles.label}>Preferred Function</label><br/>
