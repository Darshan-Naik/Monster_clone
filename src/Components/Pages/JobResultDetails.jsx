...
<div>
  <div id="jobCardDetailsBody">
    <div id="JobCard_1">
      ...
      <div id="JobCard_1_2">
        ...
        <div id="JobCard_1_2_1">
          ...
          <div>
            <img
              src="https://www.clipartkey.com/mpngs/m/135-1353077_income-transparent-background-high-income-icon-png.png"
              alt="" />
    ...
    <div id="JobCard_3_1">
      ...
      { data.skills && <div className="skill"><strong>Skills:</strong> {data.skills.map((item)=><span>
          <div className="JobCard_3_1_skill">{item}</div>
        </span>)}</div>}
  ...
  {jobs.filter(item=>JSON.stringify(item).includes(data.job_title) &&item.id !== id).length? <div
